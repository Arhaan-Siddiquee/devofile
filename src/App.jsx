...
import { FileIcon, CodeIcon, BookOpenIcon, GraduationCapIcon, BriefcaseIcon, DownloadIcon, PrinterIcon, GithubIcon } from 'lucide-react';
...
export default function DeveloperProfile() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen text-gray-800 p-6 print:bg-white print:text-black">
            ...
            {isEditing ? (
              ...
              <>
                ...
                <button 
                  ...
                  className="px-4 py-2 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 transition-colors shadow-sm flex items-center gap-2"
                >
        ...
        >
          ...
          <motion.div variants={itemVariants} className="lg:col-span-4">
            <div className="bg-white rounded-xl p-8 shadow-sm mb-8">
              {isEditing ? (
                <>
                  <div className="mb-6">
                    <label className="block text-gray-500 mb-2 text-sm font-medium">Profile Image</label>
                    <div className="w-32 h-32 rounded-full bg-gray-100 mb-4 mx-auto flex items-center justify-center border border-gray-200">
                      <span className="text-gray-400 text-sm">Upload Image</span>
                    </div>
                  </div>
                  <div className="mb-4">
                    <label className="block text-gray-500 mb-2 text-sm font-medium">Name</label>
                    <input 
                      type="text" 
                      name="name" 
                  ...
                  <div className="mb-4">
                    <label className="block text-gray-500 mb-2 text-sm font-medium">Title</label>
                    <input 
                      type="text" 
                      name="title" 
                  ...
                  <div className="mb-4">
                    <label className="block text-gray-500 mb-2 text-sm font-medium">Bio</label>
                    <textarea 
                      name="bio" 
                      value={editableProfile.bio} 
                      onChange={(e) => handleChange(e)}
                      className="w-full bg-gray-50 border border-gray-200 rounded-md px-3 py-2 h-32"
                    />
                  </div>
                </>
              ) : (
              ...
              <div className="space-y-4">
                {isEditing ? (
                  <>
                    <div>
                      <label className="block text-gray-500 mb-2 text-sm font-medium">GitHub Username</label>
                      <input 
                        type="text" 
                        name="github" 
                    ...
                    <div>
                      <label className="block text-gray-500 mb-2 text-sm font-medium">Location</label>
                      <input 
                        type="text" 
                        name="location" 
                    ...
                    <div>
                      <label className="block text-gray-500 mb-2 text-sm font-medium">Website</label>
                      <input 
                        type="text" 
                        name="website" 
                    ...
                    <div>
                      <label className="block text-gray-500 mb-2 text-sm font-medium">Education</label>
                      <input 
                        type="text" 
                        name="education" 
                  ...
                  <>
                    <div className="flex items-center text-gray-600">
                      <CodeIcon className="text-indigo-500 mr-3" size={16} />
                      <span>{profile.email}</span>
                    </div>
                    <div className="flex items-center text-gray-600">
                      <BriefcaseIcon className="text-indigo-500 mr-3" size={16} />
                      <span>{profile.location}</span>
                    </div>
                    <div className="flex items-center text-gray-600">
                      <FileIcon className="text-indigo-500 mr-3" size={16} />
                      <span>{profile.website}</span>
                    </div>
                    <div className="flex items-center text-gray-600">
                      <GraduationCapIcon className="text-indigo-500 mr-3" size={16} />
            ...
            <motion.div variants={itemVariants} className="bg-white rounded-xl p-6 shadow-sm mb-8">
              <div className="flex items-center mb-4">
                <BookOpenIcon size={18} className="mr-2 text-indigo-500" />
                <h2 className="text-lg font-semibold text-gray-900">DSA Topics</h2>
              </div>
              {isEditing ? (
                <div className="space-y-2">
                  <p className="text-sm text-gray-500 mb-2">Enter topics separated by commas</p>
                  <textarea 
                    ...
                    className="w-full bg-gray-50 border border-gray-200 rounded-md px-3 py-2 h-24"
                  />
                </div>
              ) : (
            ...
            <motion.div variants={itemVariants} className="bg-white rounded-xl p-6 shadow-sm">
              <div className="flex items-center mb-5">
                <h2 className="text-lg font-semibold text-gray-900">GitHub Stats</h2>
              </div>
              {isEditing ? (
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-gray-500 mb-1 text-sm">Repositories</label>
                    <input 
                      type="number" 
                      name="repos" 
                  ...
                  <div>
                    <label className="block text-gray-500 mb-1 text-sm">Stars</label>
                    <input 
                      type="number" 
                      name="stars" 
                  ...
                  <div>
                    <label className="block text-gray-500 mb-1 text-sm">Followers</label>
                    <input 
                      type="number" 
                      name="followers" 
                  ...
                  <div>
                    <label className="block text-gray-500 mb-1 text-sm">Contributions</label>
                    <input 
                      type="number" 
                      name="contributions" 
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-50 p-3 rounded-lg text-center">
                    <span className="text-gray-500 text-sm">Repositories</span>
                    <p className="text-2xl font-bold text-indigo-600">{profile.githubStats.repos}</p>
                  </div>
                  <div className="bg-gray-50 p-3 rounded-lg text-center">
                    <span className="text-gray-500 text-sm">Stars</span>
                    <p className="text-2xl font-bold text-amber-500">{profile.githubStats.stars}</p>
                  </div>
                  <div className="bg-gray-50 p-3 rounded-lg text-center">
                    <span className="text-gray-500 text-sm">Followers</span>
                    <p className="text-2xl font-bold text-purple-600">{profile.githubStats.followers}</p>
                  </div>
                  <div className="bg-gray-50 p-3 rounded-lg text-center">
                    <span className="text-gray-500 text-sm">Contributions</span>
                    <p className="text-2xl font-bold text-emerald-600">{profile.githubStats.contributions}</p>
                  </div>
                </div>
              )}
            </motion.div>
          ...
          <motion.div variants={itemVariants} className="lg:col-span-8 space-y-8">
            ...
            <motion.div variants={itemVariants} className="bg-white rounded-xl p-8 shadow-sm">
              <h2 className="text-lg font-semibold text-gray-900 mb-6">LeetCode Progress</h2>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div>
                  {isEditing ? (
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-gray-500 mb-1 text-sm">Total Solved</label>
                        <input 
                          type="number" 
                          name="solved" 
                      ...
                      <div>
                        <label className="block text-gray-500 mb-1 text-sm">Easy</label>
                        <input 
                          type="number" 
                          name="easy" 
                      ...
                      <div>
                        <label className="block text-gray-500 mb-1 text-sm">Medium</label>
                        <input 
                          type="number" 
                          name="medium" 
                      ...
                      <div>
                        <label className="block text-gray-500 mb-1 text-sm">Hard</label>
                        <input 
                          type="number" 
                          name="hard" 
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-gray-50 p-4 rounded-lg text-center border-l-4 border-indigo-500">
                        <span className="text-gray-500 text-sm">Total Solved</span>
                        <p className="text-3xl font-bold text-indigo-600">{profile.leetcodeStats.solved}</p>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-lg text-center border-l-4 border-green-500">
                        ...
                        <p className="text-xl font-semibold text-green-600">{profile.leetcodeStats.easy}</p>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-lg text-center border-l-4 border-yellow-500">
                        <span className="text-gray-500 text-sm">Medium</span>
                        <p className="text-xl font-semibold text-yellow-600">{profile.leetcodeStats.medium}</p>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-lg text-center border-l-4 border-red-500">
                        <span className="text-gray-500 text-sm">Hard</span>
                        <p className="text-xl font-semibold text-red-600">{profile.leetcodeStats.hard}</p>
                      </div>
                    </div>
                  )}
                </div>
            ...
            {/* Projects */}
            <motion.div variants={containerVariants} className="bg-white rounded-xl p-8 shadow-sm">
                ...
                <div className="space-y-6">
                  {editableProfile.projects.map((project, idx) => (
                    <div key={idx} className="border border-gray-200 p-4 rounded-lg bg-gray-50">
                      <div className="mb-3">
                        <label className="block text-gray-500 mb-1 text-sm">Project Title</label>
                        <input 
                          type="text" 
                          name="title" 
                          value={project.title} 
                          onChange={(e) => handleChange(e, 'projects', idx)}
                          className="w-full bg-white border border-gray-200 rounded-md px-3 py-2"
                        />
                      </div>
                      <div className="mb-3">
                        <label className="block text-gray-500 mb-1 text-sm">Description</label>
                        <textarea 
                          name="description" 
                          value={project.description} 
                          onChange={(e) => handleChange(e, 'projects', idx)}
                          className="w-full bg-white border border-gray-200 rounded-md px-3 py-2 h-20"
                        />
                      </div>
                      <div className="mb-3">
                        <label className="block text-gray-500 mb-1 text-sm">Technologies (comma separated)</label>
                        <input 
                          type="text" 
                      ...
                      <div>
                        <label className="block text-gray-500 mb-1 text-sm">Live Link</label>
                        <input 
                          type="text" 
                          name="live" 
                          value={project.live} 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {profile.projects.map((project, idx) => (
                    <motion.div 
                      ...
                      className="bg-gray-50 p-5 rounded-lg border-l-4 border-indigo-500 hover:shadow-md transition-shadow group"
                    >
                      <h3 className="font-semibold text-lg text-gray-900 mb-2 group-hover:text-indigo-600 transition-colors">{project.title}</h3>
                      <p className="text-gray-600 text-sm mb-4">{project.description}</p>
                      <div className="flex flex-wrap gap-2 mb-3">
                        {project.tech.map((tech, techIdx) => (
                          <span key={techIdx} className="bg-white text-indigo-600 text-xs px-2 py-1 rounded-full border border-indigo-100">
                            {tech}
                          </span>
                        ))}
                      </div>
                      <a href={project.live} target="_blank" rel="noopener noreferrer" className="text-indigo-600 text-sm inline-flex items-center">
